...
![A sketchnote overview of this lesson](./img/lesson-8.jpg)
...
[![Overview of Azure video](./img/00.Azure Setup Lab./what-is-azure-video-thumbnail-1740353374840-11.png)](https://www.microsoft.com/videoplayer/embed/RE4Ibng?WT.mc_id=academic-17441-jabenn)
...
![Devices connect to a service using a device SDK. Server code also connects to the service via an SDK](./img/00.Azure Setup Lab./iot-service-connectivity-1740353374841-12.png)
...
![Devices without a valid secret key cannot connect to the IoT service](./img/00.Azure Setup Lab./iot-service-allowed-denied-connection-1740353374841-13.png)
...
![The Azure IoT Hub logo](./img/00.Azure Setup Lab./azure-iot-hub-logo-1740353374841-14.png)
...
![A Microsoft cloud data center](./img/00.Azure Setup Lab./azure-region-existing.png)
![A Microsoft cloud data center planned expansion](./img/00.Azure Setup Lab./azure-region-planned-expansion.png)
...
[![Overview of Azure video](./img/00.Azure Setup Lab./what-is-azure-video-thumbnail.png)](https://www.microsoft.com/videoplayer/embed/RE4Ibng?WT.mc_id=academic-17441-jabenn)
...
![Devices connect to a service using a device SDK. Server code also connects to the service via an SDK](./img/00.Azure Setup Lab./iot-service-connectivity.png)

Your device then communicates with other parts of your application over this service - similar to how you sent telemetry and received commands over MQTT. This is usually using a service SDK or a similar library. Messages come from your device to the service where other components of your application can then read them, and messages can then be sent back to your device.

![Devices without a valid secret key cannot connect to the IoT service](./img/00.Azure Setup Lab./iot-service-allowed-denied-connection.png)
...
![The Azure IoT Hub logo](./img/00.Azure Setup Lab./azure-iot-hub-logo.png)
