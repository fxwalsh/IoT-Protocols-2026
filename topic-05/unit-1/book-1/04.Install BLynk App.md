...
## Add a Button and Gauge Widget
 ...
 Now lets add a switch widget that sends commands to the Raspberry Pi.
...
+ Now do the same for the Gauge widget and attach it to virtual pin 0 (V0). You will immediatly see the temperature data start to appear in the gauge (if not, check if the app has stopped running on the Rpi due to inactivity)
