...
## SSH Client
SSH is built into Linux, Mac OSX and Windows10. To connect to your Pi from Linux or MAC OSX, enter the following command into a terminal and replace \<IP> with the IP address of the RPi and \<username> with the user name you configured the OS with in a previous step.
