...
1. From the Raspberry Pi Imager, select the **CHOOSE OS** button, then select *Raspberry Pi OS (Other)*, followed by *Raspberry Pi OS (64-bit) Lite* . **Make sure you choose the LITE version**

    ![image-20260120130451512](./img/01.Raspberry Pi/image-20260120130451512.png)
...
1. When prompted to apply OS customisation, Do the followingto configure Wifi, login, and Secure Shell (SSH):

1. For Hostname, set you hostname to be something unique and memorable - like "RPiFrank". Also, set you username and password to something memorable (don't forget this or you'll have to do it all again.) . And set your Wifi settings to **what is given to you in class** (SSID is the wifi name and password - IT IS ALL CASE SENSITIVE). 

1. For Wifi, set SSID: **Three_086A7D** Password: **4jX58426hzv2a3Z**. It is important to do this correctly if you are connecting with the "Headless" approach. 
    ![image-20260120130750993](./img/01.Raspberry Pi/image-20260120130750993.png)

1. For remote access,  enable SSH to on and select "Use password authentication." 
    <img src="./img/01.Raspberry Pi/image-20260120130852391.png" alt="image-20260120130852391" style="zoom:50%;" />
...
1. Once you have connected, run the following to make sure your RPi libraries are up to date and we enable the  I<sup>2</sup>C interface for connecting digital sensors(more about this later...):
...
1. From the VS Code Terminal, run the following to run your Python app:
    ...
    ```output
    pi@raspberrypi:~/nightlight $ python app.py
    Hello World!
    ```
