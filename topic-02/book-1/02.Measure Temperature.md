...
1. Launch VS Code, either directly on the Pi, or connect via the Remote SSH extension.
   ...
   > ⚠️ You can refer to the previous step for VS Code connection instructi

1. Open the ``temperature-sensor`` folder 
...
😀 Your temperature sensor program is up and running!