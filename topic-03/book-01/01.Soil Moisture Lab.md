...
Before you power up the Raspberry pi, make sure it's configured to connect to the correct router in the lab. [Follow these instructions](https://tutors.dev/lab/iot-standards-protocols-2025/topic-03/book-01/Change%20Wifi%20Settings).

1. Power up the Pi and wait for it to boot

1. Launch VS Code, either directly on the Pi, or connect via the Remote SSH extension.

    > ⚠️ You can refer to [the instructions for setting up and launch VS Code in nigh if needed](https://tutors.dev/talk/iot-standards-protocols-2025/topic-02/talk-02).
