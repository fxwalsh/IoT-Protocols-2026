...
<img src="./img/03.mqtt-client/image-20250209214813193.png" alt="image-20250209214813193" style="zoom:33%;" />
...
1. Add the following code to the end of the `handle_telemetry` function:
   ...
   This sends a JSON message to the command topic with the value of `heating_on` set to true or false depending on if the light is less than 20 or not. If the light is less than 20, true is sent to instruct the device to turn heating on (in this case an  LED on.
