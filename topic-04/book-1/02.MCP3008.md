...
Once the MCP3008 is inserted, wire the ADC and Raspberry as shown below:
...
Make sure the required pyhton library is on the RPi. Use pip to install the spidev library as follows:
...
def read_channel(channel):
    ...
    # Send start bit, single/differential bit, and D2, D1, D0 bits
