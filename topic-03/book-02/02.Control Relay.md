...
1. Create a relay:
   ...
   ![The relay settings](./img/02.Control Relay/counterfit-create-relay.png)

   The relay will be created and appear in the actuators list.

   ![The relay created](./img/02.Control Relay/counterfit-relay.png)
...
1. Run the Python app. The relay will turn on and off every 10 seconds, with a half second delay between turning on and off. You will see the virtual relay in the CounterFit app close and open as the relay is turned on and off.
   ...
   ![The virtual relay turning on and off](./img/02.Control Relay/virtual-relay-turn-on-off.gif)
...
😀 Your virtual soil moisture sensor controlling a relay progra