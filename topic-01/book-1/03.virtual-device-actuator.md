# Build a nightlight - Actuator

In this step, you will add an LED to your virtual IoT device and use it to create a nightlight.
...
1. Make sure the CounterFit web app is running from the previous step. If not, start it and re-add the light sensor.
...
1. Create an LED:
    ...
    ![The LED settings](./img/counterfit-create-led.png)

    The LED will be created and appear in the actuators list.

    ![The LED created](./img/counterfit-led.png)
...
![The LED in the CounterFit app turning on and off as the light level changes](./img/virtual-device-running-assignment-1-1.gif)
